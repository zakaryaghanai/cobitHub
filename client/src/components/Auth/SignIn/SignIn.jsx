    ...
    return (
        <div className='relative flex w-full'>
            <div className='w-full overflow-hidden shadow-md
                ...
                <div
                    className='w-full md:w-[450px] max-w-[450px] bg-white/80 flex flex-col gap-4 p-10 select-none rounded-md shadow-sm'>
                    ...
                    <LoadingButton text='Sign in' withLoader={true} showLoader={isLoading}
                                   click={handleClickCustomButton}/>
                    ...
                    <div className='relative flex flex-col items-center pt-4 gap-1'>
                        ...
                        <div className='social flex justify-center gap-5 items-center'>
                            ...
                            <button
                                className='h-11 w-11 bg-zinc-50 shadow-sm rounded-full flex items-center justify-center
                                focus:ring-2 focus:ring focus:ring-zinc-200 duration-200'>
                                <svg fill="#000000" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="27px"
                                     height="27px">
                                    <path
